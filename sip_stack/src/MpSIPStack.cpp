...
mp_status_t MpSIPStack::startSIPStack(MpAccSettings const& accSettings) {
	...
	if (setSIPTransportConfig(accSettings.getPort(), "/home/liliana/pjproject-2.10/pjsip-apps/bin/pjsip_test.crt.pem",
			"/home/liliana/pjproject-2.10/pjsip-apps/bin/pjsip_test.key.pem", accSettings.getVerifyServer()) != PJ_SUCCESS) {
